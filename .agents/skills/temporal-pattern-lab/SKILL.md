...
Work on one small topic at a time.
...
Review the model in chat and wait for explicit approval before implementation.
...
- Do not create implementation or verification documents.
- If behavior differs from the model, stop and discuss the difference before redesigning it.
